...
def change_paragraph(paragraph):
    for format, content in args.filter_format.iteritems():
        search_word = "{"+format+"}"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--in', dest='infile', default="test.docx",
                                           help='input docx file name')
    parser.add_argument('--out', dest='outfile', default="new-file-name.docx",
                                           help='output docx file name')
    parser.add_argument('--format', dest='filter_format', default=formats,
                                           help='json format file which is used for changing words')
